...
(function(){
    strz_console.ConsoleText=function(lay){
        var self=this;
    ...
    strz_console.ConsoleText.prototype={
        addWindowEventListener:function(){
            window.addEventListener("keydown", function(e){
                // space and arrow keys
		document.querySelector('.kineticjs-content canvas').onkeypress= function(){
    ...
    strz_console.Extend(strz_console.ConsoleText, strz_console.Node);
})();
