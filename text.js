...
layer.add(caret).add(commandText);
...
var anim=new Kinetic.Animation(function(frame){
    if(Math.sin(frame.time*2*Math.PI/peroid)<-0.6)caret.hide();
    else caret.show();
...
var handlekeydown=function(e){
    ...
    if((e.keyCode)<91 && (e.keyCode>47)){
        ...
        //check command width limit
                ...
                break;
            case 13://enter
                if(commandText.getText()==='HELP')alert('command');
                commandText.setText('');
                break;
        }
    }
...
/* 
 * disable scroll down the site 
 * disable backspace:8 - reason Opera
 */
